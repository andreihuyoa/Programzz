...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="applicform.css" />
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Age</label>
                            <input type="number" placeholder="Enter age" required value="<?php if (isset($_GET['Agee']))
                                                                                                echo ($_GET['Agee']); ?>" />
                        </div>
                ...
                <div class="details family">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter contact number" value="<?php
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter name of contact" value="<?php
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter relationship" value="<?php
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter blood type" value="<?php
